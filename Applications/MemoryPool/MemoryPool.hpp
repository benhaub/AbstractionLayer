...
* @author Ben Haubrich                                        
* @file   MemoryPool.hpp
* @details Statically allocate memory and then allocate from it at run time in configurable blocks.
...
class MemoryPool {
    ...
    /// @brief A map of which blocks are available. TODO: Could use a stack of addresses instead.
