...
ErrorType NtpClient::connectToServer(const NtpClientTypes::NtpServerHostName hostname, const Port port) {
    ...
    ErrorType connectError = ipClient().connectTo(NtpClientTypes::ntpServerHostNameToCharArray(hostname, error).data(), port, IpTypes::Protocol::Udp, IpTypes::Version::IPv4, timeout);
